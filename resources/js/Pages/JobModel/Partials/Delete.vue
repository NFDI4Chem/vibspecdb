  ...
  <jet-action-section>
    ...
    <template #content>
      <div class="max-w-xl text-sm text-gray-600">
        Once your project is deleted, all of its resources and data will be
        permanently deleted. Before deleting your project, please download any
      ...
      <jet-dialog-modal :show="confirmingProjectDeletion" @close="closeModal">
        ...
        <template #content>
          Are you sure you want to delete your project? Once your project is
