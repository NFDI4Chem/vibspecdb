<template>
  <jet-action-section>
    <template #title> Delete Assay </template>

    <template #description> Permanently delete your Assay. </template>

    <template #content>
      <div class="max-w-xl text-sm text-gray-600">
        Once your Assay is deleted, all of its resources and data will be
        permanently deleted. Before deleting your Assay, please download any
      ...
      <jet-dialog-modal :show="confirmingAssayDeletion" @close="closeModal">
        ...
        <template #content>
          Are you sure you want to delete your Assay? Once your Assay is
