            ...
            <div class="w-screen max-w-2xl">
              ...
              >
                <div class="flex-1 h-0 overflow-y-auto">
                  <div class="py-6 px-4 sm:px-6"  :style="'background-color:'+assay.color">
                  ...
                  <div class="flex-1 flex flex-col justify-between">
                    <div class="px-4 divide-y divide-gray-200 sm:px-6">
                              ...
                              <div class="relative flex items-start">
                                ...
                                <div class="pl-7 text-sm">
                                  ...
                                  <p
                                    ...
                                    class="text-gray-500"
                                  >
                                    Only members of this assay would be able to access.
                                  </p>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="pt-4 pb-6">
                        <div v-if="form.is_public == true || form.is_public == 'true'">
                          ...
                          <div class="mt-1 flex rounded-md shadow-sm">
                            <div class="relative flex items-stretch flex-grow focus-within:z-10">
                              <input id="AssayPublicURLCopy"  v-model="assay.public_url" type="text" class="rounded-l-md focus:ring-indigo-500 focus:border-indigo-500 block w-full rounded-none rounded-l-md sm:text-sm border-gray-300" @focus="$event.target.select()" />
                            </div>
                            <button type="button" class="-ml-px relative inline-flex items-center space-x-2 px-4 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500" @click="copyToClipboard(assay.public_url, 'AssayPublicURLCopy')">
                        ...
                        <div v-else>
                          <div class="space-y-1">
                            ...
                            <div v-if="linkAccess">
                              <div class="flex">
                                <div class="flex-grow">
                                  <input id="AssayPrivateURLCopy" readonly type="text" :value="assay.private_url" class="rounded-l-md focus:ring-indigo-500 focus:border-indigo-500 block w-full rounded-none rounded-l-md sm:text-sm border-gray-300" @focus="$event.target.select()" />
                                </div>
                                <button type="button" class="-ml-px relative inline-flex items-center space-x-2 px-2 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500" @click="copyToClipboard(assay.private_url, 'AssayPrivateURLCopy')">
                                  <span><ClipboardDocumentIcon class="h-5 w-5" aria-hidden="true" /></span>
                                </button>
                              </div>
                              <div class="mt-3">
                        ...
                        <assay-activity ref="activityDetailsElement" :assay="assay"></assay-activity>
                      </div>
                    </div>
                  </div>
                </div>
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      open: false,
      selectedAccessType: publishingOptions.filter( option => option.value == this.assay.access_type)[0],
