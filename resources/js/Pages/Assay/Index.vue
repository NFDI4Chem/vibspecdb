      ...
      <div class="mt-4">
        <div class="px-6 py-4 bg-white shadow-md rounded-lg">
          ...
          <div class="mt-3 max-w-2xl text-sm text-gray-700">
            This service is organized around assays. A assay can contain as many
            studies as you wish and each study receives its own URL. Within each
            study you may upload files, select Model to process and submit your
            jobs.
          </div>
          <button
            type="button"
