<template>
  ...
  <div class="relative isolate -z-10 mt-32 sm:mt-40">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      >
        <img
          ...
          src="https://docs.ramanmetrix.eu/assets/img/logo.png"
          alt=""
        />
        <div class="w-full flex-auto">
          <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">
            <a href="ramanmetrix.eu" class="text-cyan-500">RAMANMETRIX</a>
            software compatible
          </h2>
          <p class="mt-6 text-lg leading-8 text-gray-300">
            Data structure and formats are natively compatible with Ramen Metrix
            software. This creates the possibility of initial and professional
            processing of spectra using Ramanmetrix software.
          </p>
          <ul
            role="list"
    ...
    >
      <div
        class="aspect-[1318/752] w-[82.375rem] flex-none bg-gradient-to-r from-[#80caff] to-[#1f3d56] opacity-25"
        style="
          clip-path: polygon(
            73.6% 51.7%,
            91.7% 11.8%,
