  ...
  <jet-action-section>
    ...
    <template #content>
      <div class="max-w-xl text-sm text-gray-600">
        Once your study is deleted, all of its resources and data will be
        permanently deleted. Before deleting your study, please download any
      ...
      <jet-dialog-modal :show="confirmingStudyDeletion" @close="closeModal">
        ...
        <template #content>
          Are you sure you want to delete your study? Once your study is
