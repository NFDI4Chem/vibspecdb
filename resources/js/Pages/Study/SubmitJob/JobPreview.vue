<template>
  <div class="flex-1 min-h-fit flex-row h-full">
    <div
      class="p-6 pt-0 px-0 flex-1 flex flex-col overflow-y-auto lg:order-last"
    >
    ...
    <div class="p-6 px-0 flex-1 flex flex-col overflow-y-auto lg:order-last">
      <div
        v-if="model?.id > 0"
        class="flex-1 flex-row pb-10 border-b border-gray-500"
      >
        <div
          class="flex justify-start p-2 px-5 pl-0 flex-row border-t border-gray-500 pt-8"
        >
